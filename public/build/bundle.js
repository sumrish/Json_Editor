    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-k4hcm9");
    			add_location(h1, file, 142, 4, 2803);
    			attr_dev(textarea, "class", "editor svelte-k4hcm9");
    			set_style(textarea, "border-color", /*isValidJson*/ ctx[1] ? 'inherit' : '#ea0a8e');
    			add_location(textarea, file, 144, 6, 2861);
    			attr_dev(pre, "class", "display svelte-k4hcm9");
    			add_location(pre, file, 145, 6, 3011);
    			attr_dev(div0, "class", "editor-container svelte-k4hcm9");
    			add_location(div0, file, 143, 4, 2824);
    			attr_dev(label, "for", "fileInput");
    			attr_dev(label, "class", "upload-button svelte-k4hcm9");
    			add_location(label, file, 149, 8, 3117);
    			attr_dev(input, "type", "file");
    			attr_dev(input, "id", "fileInput");
    			attr_dev(input, "accept", ".json");
    			set_style(input, "display", "none");
    			add_location(input, file, 150, 8, 3185);
    			add_location(div1, file, 148, 6, 3103);
    			attr_dev(button, "class", "download-button svelte-k4hcm9");
    			add_location(button, file, 152, 6, 3307);
    			attr_dev(div2, "class", "button-container svelte-k4hcm9");
    			add_location(div2, file, 147, 4, 3066);
    			attr_dev(div3, "class", "container svelte-k4hcm9");
    			add_location(div3, file, 141, 2, 2775);
    			add_location(main, file, 139, 0, 2765);
    		},
